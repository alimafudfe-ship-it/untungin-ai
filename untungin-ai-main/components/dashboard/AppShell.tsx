...
const NAV: Record<Locale, NavGroup[]> = {
  id: [
    { label: "Menu Utama", items: [
      ...
      { key: "trends", label: "Market Intel", helper: "Produk, toko, kreator", icon: "MI" },
  ...
  en: [
    { label: "Main Menu", items: [
      ...
      { key: "trends", label: "Market Intel", helper: "Products, shops, creators", icon: "MI" },
...
const META: Record<Locale, MetaMap> = {
  id: {
    ...
    trends: { eyebrow: "Market Intelligence", title: "Untungin Market Intelligence", subtitle: "Riset produk, kategori, toko, kreator, video & ads, dan live commerce." },
  ...
  en: {
    ...
    trends: { eyebrow: "Market Intelligence", title: "Untungin Market Intelligence", subtitle: "Research products, categories, shops, creators, video & ads, and live commerce." },
