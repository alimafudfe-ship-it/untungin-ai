...
const EXEC_COPY: Record<Locale, {
  ...
  id: {
    ...
    heroTitle: "KELOLA PROFIT, STOK, DAN KAS.", heroSubtitle: "Pantau KPI, risiko stok, performa SKU, dan aksi AI harian tanpa berpindah halaman.", addProduct: "Sinkron Toko", addCashflow: "Catat arus kas", importing: "Mengimpor...", importCSV: "Impor CSV",
...
ExecutiveDashboard    heroTitle: "Urus profit, inventori, dan aliran tunai dalam satu pusat kawalan premium.", heroSubtitle: "Pantau KPI, risiko stok, prestasi SKU, dan tindakan AI harian tanpa berpindah halaman.", addProduct: "Selaras Marketplace", addCashflow: "Catat aliran tunai", importing: "Mengimport...", importCSV: "Import CSV",
