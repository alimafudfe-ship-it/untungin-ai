...
const navItems: { key: TabKey; label: string; helper: string; icon: string }[] = [
  ...
  { key: "automation", label: "Automation", helper: "Report & alert", icon: "↯" },
...
const meta: Record<TabKey, { title: string; subtitle: string }> = {
  ...
  automation: { title: "Automation", subtitle: "Daily report & WhatsApp alert" },
  team: { title: "Team", subtitle: "Multi-user workspace" },
  assistant: { title: "AI Chat", subtitle: "Finance assistant" },
