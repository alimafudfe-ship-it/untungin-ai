...
export default function DashboardPage() {
  ...
  return <AppShell activeTab={activeTab} onTabChange={setActiveTab} isPro={isPro} proExpired={proExpired} onExport={handleExport} onUpgrade={() => openUpgradeModal("lifetime")} onLogout={handleLogout}>
    ...
    {activeTab === "forecast" && <ForecastingPanel products={products} metrics={metrics} />}
    ...
    {activeTab === "growth" && <GrowthEnginePanel products={products} metrics={metrics} userEmail={userEmail} onGoMarketplace={() => setActiveTab("marketplace")} onGoAI={() => setActiveTab("ai")} onGoBilling={() => setActiveTab("pricing")} />}
