...
export async function POST(req: Request) {
  ...
  await supabase.from("activation_events").insert({ workspace_id: workspaceId, user_id: userId, event_name: "csv_import_completed", source: "v9_first_customer_ready", metadata: { file: file.name, rows: rows.length, successRows } });
